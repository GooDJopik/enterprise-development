...
public class DataSeeder
{
    ...
    public DataSeeder()
    {
        ...
        Rentals =
        [
            new() { Id = 1, Client = Clients[0], Car = Cars[0], StartTime = new DateTime(2025, 11, 10, 8, 0, 0, DateTimeKind.Utc), DurationHours = 5 },
            new() { Id = 2, Client = Clients[0], Car = Cars[2], StartTime = new DateTime(2025, 11, 12, 19, 2, 2, DateTimeKind.Utc), DurationHours = 2 },
            new() { Id = 3, Client = Clients[0], Car = Cars[0], StartTime = new DateTime(2025, 11, 15, 9, 0, 0, DateTimeKind.Utc), DurationHours = 5 },
            new() { Id = 4, Client = Clients[0], Car = Cars[5], StartTime = new DateTime(2025, 11, 18, 10, 5, 5, DateTimeKind.Utc), DurationHours = 6 },
            new() { Id = 5, Client = Clients[1], Car = Cars[1], StartTime = new DateTime(2025, 11, 9, 10, 1, 1, DateTimeKind.Utc), DurationHours = 30 },
            new() { Id = 6, Client = Clients[1], Car = Cars[10], StartTime = new DateTime(2025, 11, 17, 13, 10, 10, DateTimeKind.Utc), DurationHours = 6 },
            new() { Id = 7, Client = Clients[2], Car = Cars[2], StartTime = new DateTime(2025, 11, 3, 11, 2, 2, DateTimeKind.Utc), DurationHours = 4 },
            new() { Id = 8, Client = Clients[2], Car = Cars[9], StartTime = new DateTime(2025, 11, 20, 10, 9, 9, DateTimeKind.Utc), DurationHours = 3 },
            new() { Id = 9, Client = Clients[3], Car = Cars[4], StartTime = new DateTime(2025, 11, 4, 12, 4, 4, DateTimeKind.Utc), DurationHours = 6 },
            new() { Id = 10, Client = Clients[4], Car = Cars[13], StartTime = new DateTime(2025, 11, 5, 9, 13, 13, DateTimeKind.Utc), DurationHours = 2 },
            new() { Id = 11, Client = Clients[4], Car = Cars[3], StartTime = new DateTime(2025, 11, 22, 11, 3, 3, DateTimeKind.Utc), DurationHours = 5 },
            new() { Id = 12, Client = Clients[5], Car = Cars[9], StartTime = new DateTime(2025, 11, 6, 12, 9, 9, DateTimeKind.Utc), DurationHours = 5 },
            new() { Id = 13, Client = Clients[5], Car = Cars[2], StartTime = new DateTime(2025, 11, 7, 11, 2, 2, DateTimeKind.Utc), DurationHours = 6 },
            new() { Id = 14, Client = Clients[5], Car = Cars[14], StartTime = new DateTime(2025, 11, 9, 14, 14, 14, DateTimeKind.Utc), DurationHours = 4 },
            new() { Id = 15, Client = Clients[5], Car = Cars[6], StartTime = new DateTime(2025, 11, 11, 10, 6, 6, DateTimeKind.Utc), DurationHours = 3 },
            new() { Id = 16, Client = Clients[5], Car = Cars[14], StartTime = new DateTime(2025, 11, 25, 9, 14, 14, DateTimeKind.Utc), DurationHours = 7 },
            new() { Id = 17, Client = Clients[6], Car = Cars[2], StartTime = new DateTime(2025, 11, 7, 9, 2, 2, DateTimeKind.Utc), DurationHours = 3 },
            new() { Id = 18, Client = Clients[7], Car = Cars[0], StartTime = new DateTime(2025, 11, 8, 10, 0, 0, DateTimeKind.Utc), DurationHours = 4 },
            new() { Id = 19, Client = Clients[7], Car = Cars[11], StartTime = new DateTime(2025, 11, 28, 15, 11, 11, DateTimeKind.Utc), DurationHours = 2 },
            new() { Id = 20, Client = Clients[8], Car = Cars[8], StartTime = new DateTime(2025, 11, 9, 11, 8, 8, DateTimeKind.Utc), DurationHours = 6 },
            new() { Id = 21, Client = Clients[9], Car = Cars[9], StartTime = new DateTime(2025, 11, 10, 12, 9, 9, DateTimeKind.Utc), DurationHours = 2 },
            new() { Id = 22, Client = Clients[9], Car = Cars[6], StartTime = new DateTime(2025, 11, 1, 8, 6, 6, DateTimeKind.Utc), DurationHours = 4 },
            new() { Id = 23, Client = Clients[10], Car = Cars[10], StartTime = new DateTime(2025, 11, 11, 9, 10, 10, DateTimeKind.Utc), DurationHours = 5 },
            new() { Id = 24, Client = Clients[11], Car = Cars[11], StartTime = new DateTime(2025, 11, 12, 14, 11, 11, DateTimeKind.Utc), DurationHours = 3 },
            new() { Id = 25, Client = Clients[12], Car = Cars[2], StartTime = new DateTime(2025, 11, 13, 9, 2, 2, DateTimeKind.Utc), DurationHours = 4 },
            new() { Id = 26, Client = Clients[13], Car = Cars[3], StartTime = new DateTime(2025, 11, 14, 10, 3, 3, DateTimeKind.Utc), DurationHours = 6 },
            new() { Id = 27, Client = Clients[14], Car = Cars[5], StartTime = new DateTime(2025, 11, 18, 11, 5, 5, DateTimeKind.Utc), DurationHours = 4 },
            new() { Id = 28, Client = Clients[14], Car = Cars[4], StartTime = new DateTime(2025, 11, 15, 11, 4, 4, DateTimeKind.Utc), DurationHours = 2 }
        ];
    }
}